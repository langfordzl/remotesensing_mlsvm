...
int main(int argc, char **argv)
{
    ...
    if(Config_params::getInstance()->get_nn_number_of_classes() == 1){
        std::string sh_command = "/usr/bin/python2 ./scripts/flann.py " +
        ...
        std::string min_command = "/usr/bin/python2 ./scripts/flann.py " +
                Config_params::getInstance()->get_p_norm_data_f_name()+ str_NN_params;
        std::string maj_command = "/usr/bin/python2 ./scripts/flann.py " +
